...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    DemoUINavigationController*  navController;
    navController = [[[DemoUINavigationController alloc] initWithRootViewController:self.viewController] autorelease];
    [navController setNavigationBarHidden:NO]; //显示导航栏
